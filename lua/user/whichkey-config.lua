...
local vmappings = {
  ["/"] = { "<Plug>(comment_toggle_linewise_visual)", "Comment selected lines (visual)" },
}
...
local mappings = {
  ...
  w = {
    ...
    k = { "<C-w>k", "Move Up" },
    l = { "<C-w>l", "Move Right" },
    v = { "<C-w>v<bar><C-w>l", "Vertical Split" },
    s = { "<C-w>s<bar><C-w>j", "Horizontal Split" },
  },
}
